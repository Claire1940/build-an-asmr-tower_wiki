...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.build-an-asmr-tower.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Build an ASMR Tower Wiki'

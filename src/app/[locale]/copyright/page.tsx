...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Build an ASMR Tower Wiki',
    description: 'Copyright and intellectual property information for Build an ASMR Tower Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Build an ASMR Tower Wiki',
      description: 'Copyright and intellectual property information for Build an ASMR Tower Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Build an ASMR Tower Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Build an ASMR Tower Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Build an ASMR Tower Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Build an ASMR Tower Developers</strong> - Creators of the Build an ASMR Tower game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Build an ASMR Tower</strong> - Trademark of the game developers</li>
              <li><strong>Build an ASMR Tower Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Build an ASMR Tower Wiki.
            </p>
            ...
            <p>
              ...
              Build an ASMR Tower Wiki<br />
              Email: <a href="mailto:dmca@build-an-asmr-tower.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@build-an-asmr-tower.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Build an ASMR Tower Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Build an ASMR Tower Wiki (build-an-asmr-tower.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@build-an-asmr-tower.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@build-an-asmr-tower.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@build-an-asmr-tower.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@build-an-asmr-tower.wiki</a>
            </p>
            <p>
